...
public class TaskAdditionConfirmServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(loginFlg) {
			...
			String category = taskBean.getCategoryName();
			String limitDate = taskBean.getLimitDate();
			String userName = taskBean.getUserName();
			String status = taskBean.getStatusName();
